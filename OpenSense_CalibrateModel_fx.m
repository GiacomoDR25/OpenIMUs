function [] = OpenSense_CalibrateModel_fx(modelFileName, orientationsFileName, baseIMUName, baseIMUHeading, visulizeCalibration, Placer_xml, sensor_to_opensim_rotation)
